        ...
        return (
          <GlassCard className="mb-3 p-8" hover key={post.path}>
            <Link className="group" href={`/posts/${post.path}`}>
              <h2 className="mb-1 border-b-2 border-gray-300 pb-1 text-xl transition duration-300 group-hover:text-green-700 dark:text-gray-200 dark:group-hover:text-green-400">
                {post.metadata?.title}
              </h2>
