        ...
        <div>
          {createdDate && (
            <div className="flex items-center gap-1">
              <Calendar className="dark:text-gray-200" size={18} />
              <span className="dark:text-gray-200">创建于 {createdDate}</span>
            </div>
          )}
          {modifiedDate && modifiedDate !== createdDate && (
            <div className="flex items-center gap-1">
              <Clock className="dark:text-gray-200" size={18} />
              <span className="dark:text-gray-200">修改于 {modifiedDate}</span>
            </div>
          )}
        </div>
      </header>
